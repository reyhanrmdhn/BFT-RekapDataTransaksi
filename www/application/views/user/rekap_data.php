    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Rekap Data</h1>
...
<div class="body-content">
    ...
    <form action="<?= base_url('user/get_data_byTanggal') ?>" method="POST" id="form_rekapdata">
        <div class="row mb-2">
            <div class="col-lg-1">
                <div class="mt-1">
            ...
            <div class="col-lg-1" style="flex:0">
                <div class="text-center" style="margin-top: 1px">
                    <button type="submit" class="btn btn-success-soft"><i class="ti ti-search"></i></button>
                </div>
            </div>
            <div class="col-lg-2">
