...
<div class="body-content">
    ...
    <form action="<?= base_url('admin/get_dataBA_byStatus') ?>" method="POST" id="form_rekapdataBAStatus">
        <div class="row mb-2">
            <div class="col-lg-1">
                <div class="mt-2">
            ...
            <div class="col-lg-5">
                <select name="status" id="status" class="form-control" required>
                    ...
                    <option value="2">Telah Di-Scan</option>
                    <option value="3">invoice Dicetak</option>
                </select>
            </div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-right">
                    <form action="<?= base_url('admin/exportBA_status') ?>" method="POST">
