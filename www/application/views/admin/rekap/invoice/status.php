...
<div class="body-content">
    ...
    <form action="<?= base_url('admin/get_dataInvoice_byStatus') ?>" method="POST" id="form_rekapdataInvoiceStatus">
        <div class="row mb-2">
            <div class="col-lg-1">
                <div class="mt-2">
                    <span style="font-weight: 600;font-size:18px;">Status</span>
                </div>
            </div>
            <div class="col-lg-5">
                <select name="status" id="status" class="form-control" required>
                    <option value="0">Status</option>
                    <option value="1">Belum Di-Scan</option>
                    <option value="2">Sedang Diproses</option>
                    <option value="3">Telah Dibayar</option>
                </select>
            </div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-right">
                    <form action="<?= base_url('admin/export_status') ?>" method="POST">
