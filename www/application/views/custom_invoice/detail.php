                    ...
                    <div class="row mt-5" style="font-size: 12px;padding:0 15px">
                        <div class="col-md-12">
                            ...
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid;width:40%;text-transform:uppercase"><?= $invoice['deskripsi']; ?></td>
                                    ...
                                    <td style="border-bottom:1px solid;text-align:right;width:20%" class="px-3">
                                        <span id="rate_num"> <?= number_format($invoice['rate']); ?>.00</span>
                                    </td>
                                    <td style="border-bottom:1px solid;text-align:right;width:20%" class="px-3">
                                        <span id="grand_num"> <?= number_format($invoice['rate'] * $qty); ?>.00</span>
                                    </td>
        ...
        <div class="modal-content text-center">
            ...
            <div style="padding:20px 50px 0px 50px;font-family:'Times New Roman';" id="invoice">
                <div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12" style="text-align:left">
                            ...
                            <table style="width:100%;font-size: 14px;">
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid;width:35%;text-transform:uppercase"><?= $invoice['deskripsi']; ?></td>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding:180px 0 180px 0">
                        </div>
                    </div>
...
<div class="md-modal md-effect-1" id="validasiPembayaran" style="width:30%">
    <div class="md-content">
        ...
        <div class="n-modal-body" style="text-align:center ;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <button class="btn btn-danger btn-block" onclick="location.href='<?= base_url('custom_invoice/pembayaran/' .  $invoice['id_invoice']) ?>'">Validasi</button>
                </div>
                <div class="col-lg-6">
