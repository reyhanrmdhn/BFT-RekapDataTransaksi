                    ...
                    <ul class="metismenu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="mm-active"><a href="timeline_vertical.html">Vertical timeline</a></li>
                ...
                <div class="body-content">
                    <div class="main">
                        <ul class="cbp_tmtimeline">
                            <li>
                                <time class="cbp_tmtime" datetime="2017-01-26 18:30"><span>01/26/17</span> <span>15:40</span></time>
                                <i class="typcn typcn-device-tablet"></i>
                                <div class="cbp_tmlabel">
                                    <h4 class="font-weight-bold">Ricebean black-eyed pea</h4>
                            ...
                            <li>
                                <time class="cbp_tmtime" datetime="2017-01-26T12:04"><span>01/26/17</span> <span>12:04</span></time>
                                <i class="typcn typcn-device-desktop"></i>
                                <div class="cbp_tmlabel">
                                    <h4 class="font-weight-bold">Greens radish arugula</h4>
                                    <p>Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette lettuce. Celery coriander bitterleaf epazote radicchio shallot winter purslane collard greens spring onion squash lentil. Artichoke salad bamboo shoot black-eyed pea brussels sprout garlic kohlrabi.</p>
                                </div>
                            </li>
                            <li>
                                <time class="cbp_tmtime" datetime="2017-01-26 05:36"><span>01/26/17</span> <span>05:36</span></time>
                                <i class="fa fa-envelope-o"></i>
                                <div class="cbp_tmlabel">
                                    <h4 class="font-weight-bold">Sprout garlic kohlrabi</h4>
                            ...
                            <li>
                                ...
                                <i class="typcn typcn-device-tablet"></i>
                                <div class="cbp_tmlabel">
                                    <h4 class="font-weight-bold">Watercress ricebean</h4>
                            ...
                            <li>
                                ...
                                <div class="cbp_tmlabel">
                                    <h4 class="font-weight-bold">Courgette daikon</h4>
