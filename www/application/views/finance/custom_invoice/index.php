                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <div class="actions">
                                <a href="<?= base_url('finance/add_custom_invoice') ?>" class="btn btn-success text-white">
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <?php foreach ($custom_invoice as $ci) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($ci['is_fix'] == 0) { ?>
                                                <button class="btn btn-info" disabled style="font-weight: 600">Draft</button>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn btn-info-soft" onclick="location.href='<?= base_url('finance/detail_custom_invoice/' . $ci['id_invoice']) ?>'"><i class="ti ti-zoom-in"></i></button>
                                        </td>
                                    </tr>
                                    <?php $x++; ?>
                                <?php endforeach; ?>
