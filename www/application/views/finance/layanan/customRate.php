                                ...
                                <div class="md-modal md-effect-1" id="deleteCustomRate<?= $custom_rate['id_layanan_join'] ?>" style="width:30%">
                                    <div class="md-content">
                                        ...
                                        <div class="n-modal-body" style="text-align:center ;">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button class="btn btn-danger btn-block" onclick="location.href='<?= base_url('finance/delete_customRate/' .  $custom_rate['id_layanan_join']) ?>'">Delete</button>
                                                </div>
                                                <div class="col-lg-6">
...
<div class="modal fade" id="editLayananCustom" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('finance/edit_layananCustom') ?>" method="POST" id="edit_layananCustom">
                    <div class="form-group">
